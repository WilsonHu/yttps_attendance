...
//
//    /**
//     * 最近一次的开门时间，5秒内同一扇门不重复开门
//     */
//    private HashMap<String, Integer> mRecentOpenTimeMap = new HashMap<>();
//
//    private static final int DOOR_OPEN_MIN_TIME = 5;
//    /**
//     * 门禁控制器IP以及名称
//     */
...
//
//        allowDeviceDoorControlMap.put("192.168.1.88", "192.168.1.103");
//        allowDeviceDoorControlMap.put("192.168.1.89", "192.168.1.103");
//        allowDeviceDoorControlMap.put("192.168.1.90", "192.168.1.103");
//
//        deviceDoorNameMap.put("192.168.1.88", "m001-1号");
//        deviceDoorNameMap.put("192.168.1.89", "m001-1号");
//        deviceDoorNameMap.put("192.168.1.90", "m001-1号");
//
...
//    }
//
//    private void openDoor(String doorServerIP, String doorName) {
//        Socket socket = null;
//        try {
//            socket = new Socket(doorServerIP, 60006);
//            OutputStream outToServer = socket.getOutputStream();
//            DataOutputStream out = new DataOutputStream(outToServer);
//            String command = "N3000 -USER abc -PASSWORD 123 -Open " + doorName;
//            out.write(command.getBytes("GB2312"));
//            out.flush();
//            out.close();
//            logger.info("Open door command: ==>" + command);
